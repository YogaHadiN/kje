  ...
  public function __construct(){
	...
	public function store()
	{
		...
		try {
            ...
            if (
                ...
                $message .= PHP_EOL;
                $message .= PHP_EOL;
                $message .= ucwords($periksa->pasien->nama);
                $message .= PHP_EOL;
                $message .= PHP_EOL;
                $message .= 'Sedang dalam antrian racikan';
                $message .= PHP_EOL;
                $message .= 'Kakak dapat *menunggu di rumah* apabila berkenan dan kami akan mengabari melalui whatsapp apabila obat sudah selesai diracik';
                $message .= PHP_EOL;
                $message .= PHP_EOL;
                $message .= '1. Saya Menunggu saja  di klinik';
                $message .= PHP_EOL;
                $message .= '2. Saya pergi dulu nanti whatsapp saya kalau obat sudah selesai diracik';
                $message .= PHP_EOL;
                $message .= PHP_EOL;
	...
	*/
    ...
    public function notifInputGambar(){
        ...
        return compact('terkirim', 'no_telp');
    }
