...
class PengeluaransControllerTest extends TestCase
{
    ...
    public function test_store(){
        ...
        $response = $this->post('pengeluarans', $inputAll);
        ...
        checkForUploadedFile($image, $pengeluaran->image);

        $response->assertRedirect('pengeluarans');
    }
    public function test_edit(){
        ...
        $response = $this->get('pengeluarans/' . $pengeluaran->id . '/edit');
        $response->assertStatus(200);
    }
    public function test_destroy(){
        ...
        auth()->login($user);
        $pengeluaran = Pengeluaran::factory()->create();
        $response = $this->delete('pengeluarans/' . $pengeluaran->id);
        $response->assertRedirect('pengeluarans');
