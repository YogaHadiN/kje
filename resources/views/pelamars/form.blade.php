		...
		<div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
			...
			{!! Form::file('image') !!}
				@if (isset($pelamar) && $pelamar->image)
					<p> <img src="{{ \Storage::disk('s3')->url('img/pelamar/'.$pelamar->image) }}" alt="" class="img-rounded upload"> </p>
				@else
					<p> <img src="{{ \Storage::disk('s3')->url('img/camera_photo_not_found.jpeg') }}" alt="" class="img-rounded upload"> </p>
				@endif
