                  ...
                  @if (count($suppliers) > 0)
                    ...
                    @foreach($suppliers as $user)
                        <tr>
                            ...
                            <td>{!!$user->pic!!}</td>
                            <td nowrap>
                                  <button type="button" class="btn btn-info btn-sm" onclick="buy(this); return false;" data-belanja-obat="1" value="Obat"><i class="fa fa-shopping-cart fa-lg"></i> Belanja Obat</button>
                            </td>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 hide">
            <div class="form-group">
              ...
              {!! Form::select('belanja_id', $belanjaList, 1, ['class' => 'form-control', 'id' => 'belanja_id_buy'])!!}
            </div>
          </div>
