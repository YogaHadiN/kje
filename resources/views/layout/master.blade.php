                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>{!! HTML::link('cek_list_bulanans', 'Cek List Bulanan')!!}</li>
					...
					@endif
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>{!! HTML::link('setor_tunais', 'Setor Tunai')!!}</li>
            ...
            <div class="col-lg-12">
                <div class="wrapper wrapper-content">
                    <div class="wrapper wrapper-content animated fadeInRight">
                        ...
                        @if (Session::has('warning_kuning'))
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="alert alert-warning">
                                            @foreach( Session::get('warning_kuning') as $warning  )
                                                <li>{!! $warning !!}</li>
                                            @endforeach
                                        </div>
                                    </div>
...
<script src="{!! url('js/twbs-pagination/jquery.twbsPagination.min.js') !!}"></script>
  <script src="{!! url('js/master.js?ver=123123') !!}"></script>
	<script>
		var base = "{{ url('/') }}";
