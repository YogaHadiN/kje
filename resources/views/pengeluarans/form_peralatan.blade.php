				...
				<div class="row">
					...
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
						<div class="form-group @if($errors->has('supplier_id'))has-error @endif">
						  ...
						  {!! Form::select('supplier_id' , App\Models\Classes\Yoga::supplierList(), null, ['class' => 'form-control selectpick rq', 'data-live-search' => 'true']) !!}
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="form-group @if($errors->has('sumber_uang'))has-error @endif">
						  ...
						  {!! Form::select('sumber_uang' , App\Models\Classes\Yoga::sumberuang(), null, ['class' => 'form-control rq']) !!}
