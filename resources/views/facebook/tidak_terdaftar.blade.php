								...
								<div class="row">
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
								       ...
								       <div class="form-group @if($errors->has('tanggal'))has-error @endif">
										  ...
										  {!! Form::select('date', $date , App\Models\Classes\Yoga::getDayFromFacebook($birthday), ['class' => 'form-control angka selectpick']) !!}
										</div>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
								       ...
								       <div class="form-group @if($errors->has('bulan'))has-error @endif">
										  ...
										  {!! Form::select('month', $month , App\Models\Classes\Yoga::getMonthFromFacebook($birthday), ['class' => 'form-control selectpick angka']) !!}
										</div>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
								       ...
								       <div class="form-group @if($errors->has('tahun'))has-error @endif">
										  ...
										  {!! Form::select('year', $year , App\Models\Classes\Yoga::getYearFromFacebook($birthday), ['class' => 'form-control angka']) !!}
										</div>
									</div>
								</div>
							</div>
