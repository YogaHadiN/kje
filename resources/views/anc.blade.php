		...
		<div class="row">
			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				...
				<div class="form-group @if($errors->has('golongan_darah'))has-error @endif">
				  ...
				  {!! Form::select('golongan_darah', App\Models\Classes\Yoga::golonganDarahList() , $golongan_darah, ['class' => 'form-control panelRiwayat', 'id' => 'golongan_darah']) !!}
		...
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				...
				<div class="form-group @if($errors->has('perujuk_id'))has-error @endif">
				  ...
				  {!! Form::select('perujuk_id' , App\Models\Classes\Yoga::perujukList(), $perujuk_id, ['class' => 'form-control selectpick', 'data-live-search' => 'true']) !!}
