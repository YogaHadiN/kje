	                <div class="alert">
	                  Surat keterangan sakit selama {!! $periksa->suratSakit->hari !!} hari mulai tanggal {!! App\Models\Classes\Yoga::updateDatePrep($periksa->suratSakit->tanggal_mulai) !!} s/d {!! $periksa->suratSakit->akhir !!}
	                  <hr>
