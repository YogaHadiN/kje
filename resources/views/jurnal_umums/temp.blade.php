                         @foreach($model->jurnals as $ky=>$jur)
                            ...
                            <tr class="b-top">
                              ...
                              @elseif($ju->jurnalable_type == 'App\Models\FakturBelanja' && $model->belanja_id == '1')
                                  <a href="{{ url('pembelians/show/' . $ju->jurnalable_id)}}" class="btn btn-primary btn-xs btn-block">Detail</a> 
                              @elseif($ju->jurnalable_type == 'App\Models\FakturBelanja'&& $model->belanja_id == '3')
                                  <a href="{{ url('pengeluarans/show/' . $ju->jurnalable_id) }}" class="btn btn-primary btn-xs btn-block">Detail</a> 
                              @elseif($ju->jurnalable_type == 'App\Models\NotaJual'&& $model->pembayaranAsuransi->count() > '0')
