...
function validasi(selector, pesan) {
    $(selector).parent().find("code").remove();
    ...
    $(selector).parent().find("code").hide().fadeIn(1000);
...
function validasi2(selector, pesan) {
    $(selector).parent().parent().find("code").remove();
    ...
    $(selector).parent().parent().find("code").hide().fadeIn(1000);
    ...
    if (getThru) {
        ...
        if (many_row == "1") {
            $(control)
                ...
                .closest("td")
                .append(
                    '&nbsp<button type="button" class="btn btn-danger" onclick="kurangInput(this); return false;"> <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> </button>'
                );
        }
        $(control)
            .closest("td")
            .html(
                '<button type="button" class="btn btn-danger" onclick="kurangInput(this); return false;"> <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> </button>'
            );
    } else {
        $(control)
            .closest("tr")
