...
class AlterPreviousComplaintResolvedAlergiObatAndMemilihObatPatenNullableToAntrianKasirsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('antrian_kasirs', function (Blueprint $table) {
