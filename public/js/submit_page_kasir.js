function submitPage() {
    ...
    $.get(
        base + "/periksas/cek_customer_survey_sudah_diisi",
        ...
        function (data, textStatus, jqXHR) {
            ...
            if (
                parseInt(tipe_asuransi_id) != 1 &&
                parseInt(tipe_asuransi_id) != 5 &&
            ...
            $.get(
                base + "/periksas/" + periksa_id + "/cek/jumlah/berkas",
                { periksa_id: periksa_id },
                function (data, textStatus, jqXHR) {
                    ...
                    if (submit) {
                        if ($("#dibayar_asuransi").val() == "") {
                            ...
                            parseInt(dibayar_pasien) >
                            parseInt(pembayaran_pasien_clean)
                        ) {
                            Swal.fire({
                                icon: "error",
                                title: "Oops...",
                        ...
                        alert(
                            "Mohon Periksa / Cek ulang apakah obat yang akan diberikan sesuai dengan resep!"
                        );
                    }
                }
            );
