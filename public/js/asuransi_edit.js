    ...
    $.get(
        ...
        function (data, textStatus, jqXHR) {
            ...
            for (let i = 0, len = data.data.length; i < len; i++) {
                ...
                temp += "</td>";
                temp += "<td class='biaya uang'>";
                temp += uang(data.data[i].biaya);
                temp += "</td>";
                temp += "<td class='jasa_dokter uang'>";
                temp += uang(data.data[i].jasa_dokter);
                temp += "</td>";
            ...
            $("#rows").html(numeral(data.rows).format("0,0"));
        }
    );
}
